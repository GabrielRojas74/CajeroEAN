...
def login():
  ...
  boton3 = tk.Button(ventana, text="validar clave", font=("titillium", 18, BOLD), fg="black", bg="grey", command=validar)
  boton3.pack(pady=20)
  botoncrear = tk.Button(ventana, text="Crear usuario", font=("titillium", 18, BOLD), fg="black", bg="grey", command=abrirventana2)
...
###
    ...
    def restaurante():
      ...
      #
    botonbanco = tk.Button(entidades, text="Banco EAN", cursor="hand2",  font=("titillium", 25, BOLD), fg="black", bg="grey", command=banco)
    botonbanco.pack(pady=10)
    botonparque = tk.Button(entidades, text="Parqueadero EAN", cursor="hand2",  font=("titillium", 25, ITALIC, BOLD), fg="black", bg="grey", command=Parqueadero)
    botonparque.pack(pady=10)
    botonres = tk.Button(entidades, text="Restaurante EAN", cursor="hand2", font=("titillium", 25, ITALIC, BOLD), fg="black", bg="grey", command=restaurante)
...
botonsig = Button(ventanain, text='Siguiente', cursor="hand2",  font=("titillium", 20, BOLD), fg="black", bg="grey", command=login)
