...
class Inicio:
    ...
    def Ean(self):
        ...
        # Label
        Label(self.Ean,text="Elige la Entidad",font=("Bahnschrift SemiBold Condensed", 20, ITALIC, BOLD), bg="WHITE", fg="#271F26", bd=10, relief=RAISED, width=60).pack()
        listentidades = LabelFrame(self.Ean, text="Lista de entidades", font=("Bodoni Bd BT", 12), bg="#28BFD7", fg="white", relief=RIDGE, bd=10)
        listentidades.place(x=0, y=100,relwidth=1)
###########
        Button(listentidades, text="Banco Ean", font=("Bodoni Bd BT", 14), bg="#1BCB0D",fg="black",command=self.Consultarcol).grid(row=0, column=0, padx=100, pady=10)
        Button(listentidades, text="Restaurante Ean", font=("Bodoni Bd BT", 14), bg="#CDA940",fg="black", ).grid(row=1, column=0, padx=100, pady=10)
...
#------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    def FacturaColp(self):
        ...
        #Datos del comprador
        datosCol = LabelFrame(self.Vcol, text="Datos del Cliente", font=(
            "Bodoni Bd BT", 12), bg="#9F5195", fg="white", relief=RIDGE, bd=10)
        datosCol.place(x=0, y=100, relwidth=1)

        Label(datosCol, text="Nombre del Cliente", font=("Bodoni Bd BT", 14),
              bg="#E2C4E1", fg="black").grid(row=0, column=0, padx=20, pady=10)

        Entry(datosCol, borderwidth=3, width=30, textvariable=self.nombre_cliente,
              state=DISABLED).grid(row=0, column=1, padx=8)

        Label(datosCol, text="Cédula", font=("Bodoni Bd BT", 14), bg="#E2C4E1",
              fg="black", width=15).grid(row=1, column=0, padx=20, pady=15)

        Entry(datosCol, borderwidth=3, width=30, textvariable=self.cedula,
              state=DISABLED).grid(row=1, column=1, padx=8)

        Label(datosCol, text="Tipo de factura", font=("Bodoni Bd BT", 14),
              bg="#E2C4E1", fg="black", width=15).grid(row=2, column=0, padx=20, pady=15)

        Entry(datosCol, borderwidth=3, width=30, textvariable=self.descripcion,
              state=DISABLED).grid(row=2, column=1, padx=8)

        Label(datosCol, text="Fecha de elaboración", font=("Bodoni Bd BT", 14),
              bg="#E2C4E1", fg="black").grid(row=0, column=2, padx=40, pady=10)

        Entry(datosCol, borderwidth=3, width=30, textvariable=self.fecha,
              state=DISABLED).grid(row=0, column=3, padx=8)

        Label(datosCol, text="No.Factura", font=("Bodoni Bd BT", 14), bg="#E2C4E1",
              fg="black", width=15).grid(row=1, column=2, padx=40, pady=15)

        Entry(datosCol, borderwidth=3, width=30, textvariable=self.numero_facturaCol,
              state=DISABLED).grid(row=1, column=3, padx=6)

        Button(datosCol, text="Generar Factura", font=("Bodoni Bd BT", 14), bg="#E2C4E1",
               fg="black", command=self.Factcolp).grid(row=2, column=3, padx=100, pady=10)

        facturacionCol = Frame(self.Vcol, bd=5, relief=GROOVE, bg="#9F5195")
        facturacionCol.place(x=0, y=360, width=600, height=380)
        Label(facturacionCol, text="Facturación", font=("Bodoni Bd BT",
              12, BOLD), bd=4, relief=SUNKEN, bg="#9F5195", fg="black").pack()
        ...
        pagocol = Button(Framepagocol, text="Pagar", font=("Bodoni Bd BT", 15), bg="#E2C4E1",
                         fg="black", width=15, command=self.MetoCol).grid(row=0, column=0, padx=15, pady=15)
        volvercol = Button(Framepagocol, text="Volver", font=("Bodoni Bd BT", 15), bg="#E2C4E1",
                           fg="black", width=8, command=self.VenAtrascol).grid(row=1, column=0, padx=15, pady=15)
    ...
    def MetoCol(self):
        ...
        Label(self.metodocol, text="Elige tu método de pago", font=("Bahnschrift SemiBold Condensed",
              20, ITALIC, BOLD), bg="#E2C4E1", fg="#271F26", bd=10, relief=RAISED, width=60).pack()
        # variables
        self.opcionpagcol = IntVar()
        Radiobutton(self.metodocol, text="Tarjeta de crédito", variable=self.opcionpagcol, value=1,
                    command=self.Seleccionarcol, font=("Bodoni Bd BT", 14), bg="#E2C4E1", fg="black").pack()
        Radiobutton(self.metodocol, text="PSE", variable=self.opcionpagcol, value=2,
                    command=self.Seleccionarcol, font=("Bodoni Bd BT", 14), bg="#E2C4E1", fg="black").pack()
        self.monitor = Label(self.metodocol)
        self.monitor.pack()
        Button(self.metodocol, text="Siguiente", font=("Bodoni Bd BT", 14),
               bg="#E2C4E1", fg="black", command=self.Pagocol).pack()
    ...
    def Pagocol(self):
        ...
        if self.opcionpagcol.get() == 1:
            ...
            Label(self.pagarcol, text="Realiza tu pago", font=("Bahnschrift SemiBold Condensed",
                  20, ITALIC, BOLD), bg="#E2C4E1", fg="#271F26", bd=10, relief=RAISED, width=60).pack()

            frameCol = LabelFrame(self.pagarcol, text="Datos del pago", font=(
                "Bodoni Bd BT", 12), bg="#9F5195", fg="white", relief=RIDGE, bd=10)
            frameCol.place(x=0, y=100, relwidth=1)

            Label(frameCol, text="Tipo de tarjeta(Visa, MasterCard)", font=(
                "Bodoni Bd BT", 14), bg="#E2C4E1", fg="black").grid(row=0, column=0, padx=10, pady=10)
            Entry(frameCol, borderwidth=3, width=30, textvariable=self.tipotarcol,
                  bg="#E2C4E1", fg="black").grid(row=1, column=0, padx=10, pady=10)
            Label(frameCol, text="código de seguridad", font=("Bodoni Bd BT", 14),
                  bg="#E2C4E1", fg="black").grid(row=2, column=0, padx=10, pady=10)
            Entry(frameCol, borderwidth=3, width=30, textvariable=self.codsegcol,
                  bg="#E2C4E1", fg="black").grid(row=3, column=0, padx=10, pady=10)
            Button(frameCol, text="Confirmar", font=("Bodoni Bd BT", 14), bg="#E2C4E1",
                   fg="black", command=self.Confirmacioncol).grid(row=4, column=0, padx=10, pady=10)
        else:
            paginacol = webbrowser.get()
            paginacol.open(
                "https://www.scotiabankcolpatria.com/personas/servicios/pagos/pagos-en-linea-pse")
    ...
    def Confirmacioncol(self):
        ...
        Label(self.concol, text="Pago Confirmado", font=("Bahnschrift SemiBold Condensed", 20,
              ITALIC, BOLD), bg="#E2C4E1", fg="#271F26", bd=10, relief=RAISED, width=60).pack()
