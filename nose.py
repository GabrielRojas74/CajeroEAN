  ...
  def entidades():
    ...
    def banco():
      ...
      for fila in range(0,len(usuarios)):
        if(usuarios[fila][0]==usuarios and usuarios[fila][1]==contraseña):
      opcion=int(input(" 2. retirar"))
      if(opcion==2):
      ...
      def opciones():
          opciones= Label(banco, text="digite el la cantidad que hay en la caja", font=("Bahnschrift SemiBold Condensed",25, BOLD), bg="purple", fg="#271F26", width="40", height=2, bd=8, relief=RAISED) 
          opciones.pack(pady=25)
      a= tk.Button(banco, text="Retiro", font=("Bahnschrift SemiBold Condensed",25, BOLD), bg="purple", fg="#271F26", width="40", height=2, bd=8, relief=RAISED,command=opciones)
      a.pack(pady=10)
      

      re = Label(Parqueadero, text="cuanto dinero", font=("Bahnschrift SemiBold Condensed",25, BOLD), bg="orange", fg="#271F26", width="40", height=2, bd=8, relief=RAISED)
      re.pack(pady=25)
      entrada3 = tk.Entry(banco)
      entrada3.pack()
